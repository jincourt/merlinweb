...
const WHY_MERLIN_POINTS = [
  {
    ...
    insight: "Fourchette habituelle pour un site vitrine one-page.",
  },
  {
    n: "02",
    value: "0 CHF",
    label: "Offre de lancement",
    insight: "Site sur mesure offert. Hébergement à 200.- CHF/an.",
    highlight: true,
  },
  {
    n: "03",
    ...
    insight: "Personnalisé et professionnel — conçu pour vous.",
  },
];
    ...
    <section id="pourquoi" className="why-merlin-section scroll-mt-16">
      <div className="mx-auto max-w-[1200px] px-5 sm:px-8 py-28 sm:py-40">
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24 lg:items-start">
          <MotionDiv>
            <p className="flex items-center gap-1.5 t-mono !text-[0.875rem] !text-black/70">
              <Star
                size={16}
                strokeWidth={0}
                fill="currentColor"
            ...
            <p className="t-body mt-6 max-w-md">
              Entre les agences hors de prix et les templates
              interchangeables, Merlin allie exigence et simplicité — avec un
              suivi humain de A à Z.
            </p>

            <ReserveCta className="mt-10 hidden lg:flex" />
          </MotionDiv>
