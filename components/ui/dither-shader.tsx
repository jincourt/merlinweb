...
interface DitherShaderProps {
  ...
  /** Vertical alignment when objectFit leaves empty space */
  objectPosition?: "center" | "bottom";
  /** Skip source pixels darker than this luminance (0–1) */
  darkCutoff?: number;
  /** Skip dark dither squares instead of rendering them */
  hideDarkSquares?: boolean;
    ...
    (
      ...
      for (let y = 0; y < displayHeight; y += effectivePixelSize) {
        for (let x = 0; x < displayWidth; x += effectivePixelSize) {
          ...
          if (darkCutoff !== undefined && luminance < darkCutoff) continue;
          ...
          switch (colorMode) {
            case "grayscale": {
              ...
              if (hideDarkSquares && shouldBeDark) continue;
